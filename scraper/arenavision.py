...
def List(url):
    try:
        ...
        with open("arenavision.html", "w") as text_file:
...
print("... start");
texto=List('http://87.120.36.172:8081/wideedge/vp6ug4a/playlist.m3u8?wmsAuthSign=c2VydmVyX3RpbWU9MTAvMTQvMjAxNyA2OjQ0OjAyIFBNJmhhc2hfdmFsdWU9OWNZSi8xMFFCVllyUGxMYUhWTngwZz09JnZhbGlkbWludXRlcz0yMA==')
